    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroup7bjrMDp (QseAem7wPnkcCfX6Y97bjR)
                ...
                children: [
                  Positioned(
                    ...
                    child: Container(
                      ...
                      height: 4972*fem,
                      decoration: BoxDecoration (
                        color: Color(0xff1dabdc),
                      ),
                      child: Stack(
                        children: [
                          Positioned(
                            // rectangle426NPp (1:8968)
                            left: 0*fem,
                            top: 87*fem,
                            child: Align(
                              child: SizedBox(
                          ...
                          Positioned(
                            ...
                            child: Align(
                              child: SizedBox(
                                ...
                                height: 36.9*fem,
                                child: Image.asset(
                                  'assets/page-1/images/group-14-UUv.png',
                                  width: 36.92*fem,
                                  height: 36.9*fem,
                                ),
                              ),
                          ...
                          Positioned(
                            // iphonex11prolightbase8fp (1:8974)
                            left: 0*fem,
                            top: 0*fem,
                            child: Align(
                              child: SizedBox(
                                ...
                                height: 44*fem,
                                child: Image.asset(
                                  'assets/page-1/images/iphone-x-11-pro-light-base-58J.png',
                                  width: 414*fem,
                                  height: 44*fem,
                                ),
                              ),
                  ...
                  Positioned(
                    // rolluptermsandconditionsrevise (1:8999)
                    left: 31*fem,
                    top: 107*fem,
                    child: Align(
                      child: SizedBox(
            ...
            Container(
              // iconinterfacescheckmarkcirclet (1:9000)
              margin: EdgeInsets.fromLTRB(31*fem, 0*fem, 0*fem, 0*fem),
              width: 20*fem,
              height: 20*fem,
              child: Image.asset(
                'assets/page-1/images/icon-interfaces-checkmark-circle.png',
                width: 20*fem,
                height: 20*fem,
              ),
            ),
